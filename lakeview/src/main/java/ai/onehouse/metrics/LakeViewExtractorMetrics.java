...
public class LakeViewExtractorMetrics {
  ...
  static final String EXTRACTOR_CONFIG_LOAD_COUNTER = METRICS_COMMON_PREFIX + "extractor_config_load";
  ...
  public void incrementExtractorConfigLoadCounter() {
    metrics.increment(EXTRACTOR_CONFIG_LOAD_COUNTER, getDefaultTags());
  }
